...
class CalendarTestCase(TestCase):
    ...
    def test_calendar_urls(self):
        ...
        response = self.client.get(
            reverse("calendar", kwargs={"item_type": "tool", "item_id": tool.id}),
            follow=True,
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_event_feed(self):
        ...
        response = self.client.get(
            reverse("event_feed"), data={"start": "2021-05-03"}, follow=True
        )
        self.assertEqual(response.status_code, 400)
        ...
        response = self.client.get(
            reverse("event_feed"),
            data={"start": "2021-05-03", "end": "2021-05-02"},
            follow=True,
        )
        self.assertEqual(response.status_code, 400)
        ...
        response = self.client.get(
            reverse("event_feed"),
            data={"start": "2021-05-03", "end": "2021-05-10"},
            follow=True,
        )
